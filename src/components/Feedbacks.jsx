...
const FeedbackCard = ({
  ...
  <motion.div
    ...
    className="bg-black-200 px-8 py-5 rounded-3xl xs:w-[320px] w-full"
  >
    ...
    <div className={`bg-black-100 rounded-[20px]`}>
      ...
      >
        <motion.div variants={textVariant()}>
          <p className={styles.sectionSubTitle}>What others say</p>
          <h2 className={styles.sectionHeadTitle}>Testimonials</h2>
          <SectionDivider height="40px" width="225px" />
        </motion.div>
      </div>
